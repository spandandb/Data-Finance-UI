        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
          ...
          <div className='flex flex-col justify-center items-center my-4 text-center'>
            ...
            <p className='font-semibold'>
              We provide you with your one stop application for tracking your
              data analytics in a brand new hassle free way. Click on the button
              below to sign up for our services.
            </p>
